    ...
    return (
        ...
        <nav className={`navbar navbar-expand-lg navbar-${props.mode}  bg-${props.mode}`}>
            <div className="container-fluid">
                ...
                <div className={`form-check form-switch  text-${props.mode === 'light' ? 'dark' : 'light'} ,c`}>
                    <input className="form-check-input" onClick={props.togol} type="checkbox" id="flexSwitchCheckDefault" />
